...
<table class="post_table">
 ...
 ?>
 <tr>
  <td><?php print(htmlspecialchars($userdata['id'])); ?> </td>
  <td><?php print(htmlspecialchars($userdata['title'])); ?> </td>
  <td><?php print(htmlspecialchars($userdata['category_no'])); ?> </td>
  <td><?php print(htmlspecialchars($userdata['comment'])); ?> </td>
  <td><?php print(htmlspecialchars($userdata['created'])); ?> </td>
 </tr>
 <?php
 }
 ?>
