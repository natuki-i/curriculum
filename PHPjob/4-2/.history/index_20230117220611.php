...
<table class="post_table">
 ...
 ?>
 <tr>
  <td><?php printf(htmlspecialchars($postdata['id'])); ?> </td>
  <td><?php printf(htmlspecialchars($postdata['title'])); ?> </td>
  <td><?php printf(htmlspecialchars($postdata['category_no'])); ?> </td>
  <td><?php printf(htmlspecialchars($postdata['comment'])); ?> </td>
  <td><?php printf(htmlspecialchars($postdata['created'])); ?> </td>
 </tr>
 <?php
 }
 ?>
