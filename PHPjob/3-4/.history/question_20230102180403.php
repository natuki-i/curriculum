...
<form action="answer.php" method="post">
    ...
    foreach ($answer1 as $key => $value) { ?>
        <input type="radio" name="answer1" value=<?php printf($value) ?>>
    <?php echo $value;
    }
    ?>
    ...
    foreach ($answer2 as $value) { ?>
        <input type="radio" name="answer2" value=<?php printf($value) ?>>
    <?php echo $value;
    }
    ?>
    ...
    foreach ($answer3 as $value) { ?>
        <input type="radio" name="answer3" value=<?php printf($value) ?>>
    <?php echo $value;
    }
    ?>
    ...
    ?>
    <input type="hidden" name="correct1" value=<?php printf($port) ?> />
